...
public class HouseholdSurveySpecification {

    public static Specification<HouseholdSurvey> filterByQueryObject(ExcelQueryObject excelQueryObject) {
        return (root, query, criteriaBuilder) -> {
            ...
            if (excelQueryObject.getSurveyorNames() != null && !excelQueryObject.getSurveyorNames().isEmpty()) {
                predicates.add(root.get("filledByName").in(excelQueryObject.getSurveyorNames()));
            }
            ...
            if (excelQueryObject.getVillages() != null && !excelQueryObject.getVillages().isEmpty()) {
                predicates.add(root.get("village").in(excelQueryObject.getVillages()));
            }
